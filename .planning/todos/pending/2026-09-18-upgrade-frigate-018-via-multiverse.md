...
As of nixpkgs history through 2026-09-17, the newest packaged version is 0.17.2 (`mvs query versions frigate`), so there is no rev to pin yet; nixpkgs picked up 0.17.0 three days after its release, so 0.18.0 should land within days-to-weeks.
