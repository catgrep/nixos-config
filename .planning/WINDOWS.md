...
fixed_count: 0
total_count: 14
last_updated: 2026-08-25T15:12:03.179Z
---
...
| 13 | 13 | deviation | scripts/smoketests/media/all.sh | 76 | Checks legacy /mnt/media/downloads/complete path that predates Phase 12's torrent-stack retirement and no longer exists; confirmed pre-existing via Plan 13-01 preflight inventory, not a restore defect | open |  | 2026-08-25T15:12:03.082Z |  |
| 14 | 13 | deviation | .planning/phases/13-zfs-mirror-migration/deferred-items.md |  | Systemic ACL gap: base group:: entry is r-x (not rwx) on ~280 tv/movies directories, blocking Bazarr write access; confirmed pre-existing (identical ACL on backup/media-staging predating ZFS work), needs a separately-scoped setfacl normalization pass | open |  | 2026-08-25T15:12:03.179Z |  |
...
[
  ...
  },
  {
    ...
    "kind": "deviation",
    "phase": "13",
    "file": "scripts/smoketests/media/all.sh",
    "line": 76,
    "description": "Checks legacy /mnt/media/downloads/complete path that predates Phase 12's torrent-stack retirement and no longer exists; confirmed pre-existing via Plan 13-01 preflight inventory, not a restore defect",
    "status": "open",
    "reason": "",
    "recorded_at": "2026-08-25T15:12:03.082Z",
    "resolved_at": null
  },
  {
    "id": 14,
    "kind": "deviation",
    "phase": "13",
    "file": ".planning/phases/13-zfs-mirror-migration/deferred-items.md",
    "line": null,
    "description": "Systemic ACL gap: base group:: entry is r-x (not rwx) on ~280 tv/movies directories, blocking Bazarr write access; confirmed pre-existing (identical ACL on backup/media-staging predating ZFS work), needs a separately-scoped setfacl normalization pass",
    "status": "open",
    "reason": "",
    "recorded_at": "2026-08-25T15:12:03.179Z",
    "resolved_at": null
  }
]
````
