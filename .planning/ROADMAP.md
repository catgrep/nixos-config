...
- [ ] 08-02-PLAN.md -- Extract Sonarr, Radarr, and Prowlarr host slices with owned exporters

**Wave 3** *(blocked on Wave 2 completion)*

- [ ] 08-03-PLAN.md -- Extract NZBGet, SABnzbd, and qBittorrent host slices
...
- [ ] 08-05-PLAN.md -- Split helpers, extract orchestration and SOPS support, remove legacy aggregates

**Wave 6** *(blocked on Wave 5 completion)*

- [ ] 08-06-PLAN.md -- Remove dead media modules and adjacent AllDebrid remnants
